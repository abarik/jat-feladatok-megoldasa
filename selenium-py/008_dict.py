...
# Állapítsuk meg, hogy az alábbi szövegben (TEXT) melyik szó hányszor fordul elő és
# írassuk ki az eredményt a következő formában:
...
# Minden szó kisbetűsen szerepeljen, vagyis pl. a 'The' és 'the'
# szavak azonos szónak számítanak.
#
...
words = TEXT.split()  # lista a szóközök mentén
my_dict = dict()  # üres lista
for word in words:
